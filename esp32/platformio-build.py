...
env.Append(
    ...
    CPPPATH=[
        ...
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "bus", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "esp-nn", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "esp-nn", "src", "common"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "screen", "controller_driver", "ili9341"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "screen", "controller_driver", "st7789"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "screen", "controller_driver", "st7796"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "screen", "controller_driver", "nt35510"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "screen", "controller_driver", "ili9806"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "screen", "controller_driver", "ili9486"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "screen", "controller_driver", "ili9488"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "screen", "controller_driver", "ssd1351"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "screen", "controller_driver", "rm68120"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "screen", "controller_driver", "ssd1306"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "screen", "controller_driver", "ssd1307"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "screen", "controller_driver", "ssd1322"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "screen", "controller_driver", "ssd1963"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "screen", "interface_driver"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "screen"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "tflite-lib"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "tflite-lib", "third_party", "gemmlowp"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "tflite-lib", "third_party", "flatbuffers", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "tflite-lib", "third_party", "ruy"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "tflite-lib", "third_party", "kissfft"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "tflite-lib", "signal", "micro", "kernels"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "tflite-lib", "signal", "src"),
        join(FRAMEWORK_SDK_DIR, "esp32", "include", "tflite-lib", "signal", "src", "kiss_fft_wrappers"),
