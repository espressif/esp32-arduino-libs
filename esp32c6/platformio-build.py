...
env.Append(
    ...
    CPPPATH=[
        ...
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "cbor2", "port", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "esp_diag_data_store", "src", "rtc_store"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "esp_diag_data_store", "include"),
