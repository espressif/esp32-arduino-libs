...
env.Append(
    ...
    CPPPATH=[
        ...
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "tflite-micro"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "tflite-micro", "third_party", "gemmlowp"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "tflite-micro", "third_party", "flatbuffers", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "tflite-micro", "third_party", "ruy"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "tflite-micro", "third_party", "kissfft"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "tflite-micro", "signal", "micro", "kernels"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "tflite-micro", "signal", "src"),
        join(FRAMEWORK_SDK_DIR, "esp32c6", "include", "tflite-micro", "signal", "src", "kiss_fft_wrappers"),
