...
env.Append(
    ...
    CPPPATH=[
        ...
        join(FRAMEWORK_SDK_DIR, "esp32s2", "include", "cbor2", "port", "include"),
        ...
        join(FRAMEWORK_SDK_DIR, "esp32s2", "include", "esp_diag_data_store", "src", "rtc_store"),
        join(FRAMEWORK_SDK_DIR, "esp32s2", "include", "esp_diag_data_store", "include"),
