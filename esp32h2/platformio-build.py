...
env.Append(
    ...
    CPPPATH=[
        ...
        join(FRAMEWORK_SDK_DIR, "esp32h2", "include", "espressif__esp32-camera", "driver", "include"),
        join(FRAMEWORK_SDK_DIR, "esp32h2", "include", "espressif__esp32-camera", "conversions", "include"),
